		        ...
		        <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
					<Section className="text-center">
						...
						<Text className="text-base text-black mt-2">
							Your account has been completely deleted from the Dewstream database. All your data and information have been permanently removed.
						</Text>
					</Section>

					<Section className="bg-white text-black text-center rounded-lg shadow-md p-6 mb-4">
						<Text>
							You will no longer receive notifications in Telegram and on your email.
						</Text>
						<Text>
							If you want to return to the platform, you can register using the link below:
						</Text>
						<Link
							href={registerLink}
